...
from tennis_value.ingestion import IngestedOddsApiResponse
...
class SqliteOddsRepository:
    ...
    def latest_snapshots_as_of(
        ...
        *,
        ...
        """Return each bookmaker's latest fresh snapshot known at decision time."""
        ...
        oldest_allowed = decision_at - maximum_age
        rows = self._connection.execute(
            """
            ...
            (
                ...
                _datetime_to_storage(oldest_allowed),
                match_id,
            ),
        ).fetchall()
